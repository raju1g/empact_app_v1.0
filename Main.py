...
plt.text(9, 0.7, '-- 50% voluntary turnover', size=10, color='lightblue')
plt.text(9, 0.66, 'after 5 years', size=10, color='lightblue')
plt.text(9, 0.3, '-- 50% involuntary turnover', size=10, color='orange')
plt.text(9, 0.26, 'after {involuntary_x_median} years', size=10, color='orange')
