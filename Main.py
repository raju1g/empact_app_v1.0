    ...
    st.write(
        ...
        opacity: 0.8; background-size: 80px;">
            <div class="hero-wrapper">
                <div class="hero-container" style="width:100%; height:100px">
                    <div class="hero-container-content">
                        <span class="subpages-subcontainer-product white-span" style="margin-left: -0.5em; text-transform: capitalize; color: #224B90;">Cost € "{:,}".format({total_cost_voluntary})</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    st.write(
        ...
        opacity: 0.8; background-size: 80px;">
            <div class="hero-wrapper">
                <div class="hero-container" style="width:100%; height:100px">
                    <div class="hero-container-content">
                        <span class="subpages-subcontainer-product white-span" style="margin-left: -0.5em; text-transform: capitalize; color: #224B90;">Cost € "{:,}".format({total_cost_involuntary})</span>
                    </div>
                </div>
            </div>
        </div>
